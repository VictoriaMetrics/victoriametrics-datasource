...
BUGFIX: fix query editor issues causing incorrect query loading and formatting. See [this issue](https://github.com/VictoriaMetrics/victoriametrics-datasource/issues/234).
