import { InlineField, InlineFieldRow, RadioButtonGroup, Select, FilterPill, Stack } from 'packages/grafana-ui/src';
...
} from '@grafana/data/transformations/transformers/labelsToFields';
