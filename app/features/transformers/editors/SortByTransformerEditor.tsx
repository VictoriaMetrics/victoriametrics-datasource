import { InlineField, InlineSwitch, InlineFieldRow, Select } from 'packages/grafana-ui/src';
import React, { useCallback } from 'react';

import { DataTransformerID, standardTransformers, TransformerRegistryItem, TransformerUIProps } from '@grafana/data';
import { SortByField, SortByTransformerOptions } from '@grafana/data/transformations/transformers/sortBy';
