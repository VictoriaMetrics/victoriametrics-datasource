import { LegacyForms, Select, StatsPicker } from 'packages/grafana-ui/src';
...
import { ReduceTransformerMode, ReduceTransformerOptions } from '@grafana/data/transformations/transformers/reduce';
