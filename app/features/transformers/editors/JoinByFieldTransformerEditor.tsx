import { Select, InlineFieldRow, InlineField } from 'packages/grafana-ui/src';
...
import { JoinByFieldOptions, JoinMode } from '@grafana/data/transformations/transformers/joinByField';
