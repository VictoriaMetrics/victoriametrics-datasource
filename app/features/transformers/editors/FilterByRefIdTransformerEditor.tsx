import { HorizontalGroup, FilterPill } from 'packages/grafana-ui/src';
...
import { FilterFramesByRefIdTransformerOptions } from '@grafana/data/transformations/transformers/filterByRefId';
