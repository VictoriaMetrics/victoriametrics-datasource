...
import { FilterPill, HorizontalGroup, Input, LegacyForms, Select, StatsPicker } from 'packages/grafana-ui/src';
...
import {
  ...
  getNameFromOptions,
  ReduceOptions,
} from '@grafana/data/transformations/transformers/calculateField';
