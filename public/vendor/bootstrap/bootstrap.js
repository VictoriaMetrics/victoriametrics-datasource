...
!function($) {
  ...
  Tooltip.prototype = {
    ...
    , leave: function(e) {
      let self = $(e.currentTarget)[this.type](this._options).data(this.type)
    ...
    , toggle: function(e) {
      let self = e ? $(e.currentTarget)[this.type](this._options).data(this.type) : this
...
!function($) {
  ...
  let Typeahead = function(element, options) {
    this.$element = $(element)
  ...
  Typeahead.prototype = {
    ...
    , select: function() {
      ...
      let val = this.$menu.find('.active').attr('data-value') || this.$element.val();
      this.$element
    ...
    , show: function() {
      let pos = $.extend({}, this.$element.position(), {
