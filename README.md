   ...
   ```yaml
     ...
     services:
       grafana:
         ...
         environment:
         - GF_INSTALL_PLUGINS=https://github.com/VictoriaMetrics/victoriametrics-datasource/releases/download/v0.12.3/victoriametrics-metrics-datasource-v0.12.3.zip;victoriametrics-metrics-datasource
...
``` yaml
plugins:
  - https://github.com/VictoriaMetrics/victoriametrics-datasource/releases/download/v0.12.3/victoriametrics-metrics-datasource-v0.12.3.zip;victoriametrics-metrics-datasource
```
