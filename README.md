  ...
  - name: "load-vm-ds-plugin"
    ...
    args:
     ...
     - |
       ...
       curl -L https://github.com/VictoriaMetrics/victoriametrics-datasource/releases/download/$ver/victoriametrics-datasource-$ver.linux_${arch}.tar.gz -o /var/lib/grafana/plugins/vm-plugin.tar.gz
